...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OBSR features */
        {"obsr", "masternode", &masternode, true, true, false},
        {"obsr", "listmasternodes", &listmasternodes, true, true, false},
        {"obsr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"obsr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"obsr", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"obsr", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"obsr", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"obsr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"obsr", "masternodedebug", &masternodedebug, true, true, false},
        {"obsr", "startmasternode", &startmasternode, true, true, false},
        {"obsr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"obsr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"obsr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"obsr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"obsr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"obsr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"obsr", "mnbudget", &mnbudget, true, true, false},
        {"obsr", "preparebudget", &preparebudget, true, true, false},
        {"obsr", "submitbudget", &submitbudget, true, true, false},
        {"obsr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"obsr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"obsr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"obsr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"obsr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"obsr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"obsr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"obsr", "checkbudgets", &checkbudgets, true, true, false},
        {"obsr", "mnsync", &mnsync, true, true, false},
        {"obsr", "spork", &spork, true, true, false},
        {"obsr", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzobsrseed", &getzobsrseed, false, false, true},
...
{
    return "> obsr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9568/\n";
}
